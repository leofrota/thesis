...
setwd("~/GitHub/Tese/Tese/base sus")
df <- list.files(pattern = "2018")
df_2018 <- read.csv(df, sep = "\t", quote = "")

### Base Sistema de Informação de Nascidos Vivos

#ETLSINASC.DNRES_2017 <- read.delim("~/GitHub/Tese/Tese/ETLSINASC.DNRES_2017.csv")
amostra_nascidos <- read.csv("~/GitHub/Tese/Tese/amostra_nascidos.csv")
